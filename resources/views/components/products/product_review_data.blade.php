                    ...
                    <div class="media-body">
                        ...
                        @auth
                            @if($row->user_id == \Auth::user()->id)
                                <form action="{{ route('products.remove.my.review') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="active_tab" value="reviews">
                                    <input type="hidden" name="product_id" value="{{ isset($product_id) ? $product_id : $data->id }}" />
