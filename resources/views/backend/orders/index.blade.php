...
@section('body_content')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="margin" style="margin-bottom: 10px;">
                            <div class="btn-group">
                                <a href="{{ route('orders.index') }}" class="btn btn-info btn-block"><i class="fa fa-refresh"></i> Reload</a>
                            </div>
                            {{--<div class="btn-group">--}}
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">All Order Details</h3>
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @if(\App\Orders::WhereNull('is_deleted')->get()->count()>0)
                                        @foreach(\App\Orders::WhereNull('is_deleted')->orderby('created_at','DESC')->get() as $row)
                                            <tr>
                                                <td>{{ $row->id }}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('orders.view', [HashEncode($row->id), 'order_index']) }}" class="btn btn-success"><i class="fa fa-eye"></i></a>
    ...
    <div class="modal fade" id="modal-bulk-delete">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-title">Delete All Orders</h4>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Are sure want to delete all orders?</p>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-info" data-dismiss="modal">Close</button>
    ...
    <form action="{{ route('admin.record.delete','orders') }}" id="delete-record-form" method="POST">
        @csrf
    </form>
@endsection
