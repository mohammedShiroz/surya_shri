<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd"><html data-editor-version="2" class="sg-campaigns" xmlns="http://www.w3.org/1999/xhtml"><head>
    ...
    <title>{{ config('app.name') }} Service Reservation Confirmed</title>
    <!--<![endif]-->
    <!--[if (gte mso 9)|(IE)]>
    <xml>
                                                                                        ...
                                                                                        <td style="padding:18px 30px 18px 30px; line-height:22px; text-align:inherit; background-color:#ffffff;" height="100%" valign="top" bgcolor="#ffffff" role="module-content">
                                                                                            <div>
                                                                                                <div style="font-family: inherit; text-align: left">
                                                                                                    <span style="font-size: 18px">You've requested a {{ $data->service->name }} reservation. The reservation has been confirmed and be available on time.</span>
                                                                                                    <table class="table" style="margin-top: 15px; border: 1px solid grey; width: 100%; padding:10px;">
                                                                                                        <tr>
                                                                                                            <td align="center" style="width: 29%; font-weight: 800; background: #e0e0e0; padding: 15px; text-transform: uppercase;" colspan="2"><strong>Be Available <span style="color: green;">On {{ date('l',strtotime($data->book_date)) }} {{ date('d M, Y',strtotime($data->book_date)) }} at {{ $data->book_time }}</span></strong></td>
                                                                                                        </tr>
                                                                                                    </table>
                                                                                            ...
                                                                                            <table border="0" cellpadding="0" cellspacing="0" class="wrapper-mobile" style="text-align:center;">
                                                                                                ...
                                                                                                <tr>
                                                                                                    <td align="center" bgcolor="#ffbe00" class="inner-td" style="border-radius:6px; font-size:16px; text-align:center; background-color:inherit;">
                                                                                                        <a href="{{ route('dashboard.reservations') }}" style="background-color:#ffbe00; border:1px solid #ffbe00; border-color:#ffbe00; border-radius:0px; border-width:1px; color:#000000; display:inline-block; font-size:14px; font-weight:normal; letter-spacing:0px; line-height:normal; padding:12px 40px 12px 40px; text-align:center; text-decoration:none; border-style:solid; font-family:inherit;" target="_blank">Check Dashboard</a>
                                                                                                    </td>
                                                                                                </tr>
                                                                                                </tbody>
                                                                                            </table>
