                ...
                <div class="row">
                    <div class="col-12">
                        <div class="margin" style="margin-bottom: 10px;">
                            ...
                            <div class="btn-group">
                                <a href="{{ route('role.create') }}" class="btn btn-info btn-block"><i class="fa fa-plus-circle"></i> Add a Role</a>
                            </div>
                            @endpermission
                            <div class="btn-group">
                                <a href="{{ route('role.index') }}" class="btn btn-info btn-block"><i class="fa fa-refresh"></i> Reload</a>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @foreach($data as $row)
                                        <tr>
                                            <td>{{ $loop->index+1 }}</td>
                                            <td><a href="{{route('role.show',HashEncode($row->id))}}">{{$row->name}}</a></td>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    <a href="{{ route('role.show', HashEncode($row->id))}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                    @permission('update-role')
                                                    <a href="{{ route('role.edit', HashEncode($row->id))}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                    @endpermission
