...
@section('body_content')
                    ...
                    <div class="col-12">
                        <div class="margin" style="margin-bottom: 10px;">
                            @if(isset($add_page) or isset($edit_page))
                                <div class="btn-group">
                                    <a href="{{ url('bay-admin/sub-categories')}}"
                                       class="btn btn-success btn-block"><i class="fa fa-long-arrow-left"></i> Back</a>
                                </div>
                            @else
                                <div class="btn-group">
                                    <a href="{{ url('bay-admin/sub-categories/create')}}"
                        ...
                        @if(isset($add_page))
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                {!! Form::open(['action' => 'MainCategoryController@store_sub_category', 'class' => 'form-horizontal','role' => 'form', 'method' => 'POST']) !!}
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                        ...
                        @elseif(isset($edit_page))
                            <div class="card card-info">
                                ...
                                <!-- /.card-header -->
                                <!-- form start -->
                                {!! Form::open(['action' => ['MainCategoryController@update_sub_category',$category->id], 'class' => 'form-horizontal','role' => 'form', 'method' => 'POST']) !!}
                                {{ csrf_field() }}
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                    ...
                                    @if(count($categories)>0)
                                        @foreach($categories as $category)
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ url('bay-admin/sub-categories/'.$category->id.'/edit')}}"
    ...
    <div class="modal fade" id="modal-bulk-delete">
        <div class="modal-dialog ">
            <div class="modal-content">
                <div class="modal-header bg-info">
                    <h4 class="modal-title">Delete All Sub Categories</h4>
                    <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <p>Are sure want to delete all sub categories?</p>
                </div>
                <div class="modal-footer justify-content-between">
                    <button type="button" class="btn btn-info" data-dismiss="modal">Close</button>
    ...
    <script>
        ...
        $(function () {
            $(".btn-delete-now").on('click', function (e) {
                location.href = '/bay-admin/sub-categories/delete/' + get_id;
            });

            $(".btn-delete-all-now").on('click', function (e) {
                location.href = '/bay-admin/sub-categories/delete/all/bulk-delete';
            });
        });
    </script>
@endsection