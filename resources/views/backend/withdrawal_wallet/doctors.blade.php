...
@section('page_title','Doctors Wallet Withdrawals')
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title text-uppercase">Doctor Withdrawal Fee Details</h3>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                        <form action="{{ route('withdrawal-details.update',(\App\WithdrawalDetails::where('type','Doctor')->firstOrFail()->id)) }}" method="POST">
                                            @csrf
                                            @method('put')
                                            <div class="row">
                                                <div class="form-group col-6">
                                                    <label>Wallet Type</label>
                                                    <input type="text" name="type" readonly value="{{ old('type')? old('type') : 'Doctor'  }}" class="form-control" placeholder="Wallet type" />
                                                ...
                                                <div class="form-group col-3">
                                                    ...
                                                    <input type="text" id="withdrawal_fee" name="fee_amount" value="{{ old('fee_amount')? old('fee_amount') : ((\App\WithdrawalDetails::where('type','Doctor')->firstOrFail()->fee_amount)? \App\WithdrawalDetails::where('type','Doctor')->firstOrFail()->fee_amount : null)  }}" class="form-control" placeholder="Withdrawal Fee Amount" />
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <input type="text" id="minimum_limit" name="minimum_limit" value="{{ old('minimum_limit')? old('minimum_limit') : ((\App\WithdrawalDetails::where('type','Doctor')->firstOrFail()->minimum_limit)? \App\WithdrawalDetails::where('type','Doctor')->firstOrFail()->minimum_limit : '0')  }}" class="form-control" placeholder="Withdrawal Minimum limit" />
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <input type="text" id="maximum_limit" name="maximum_limit" value="{{ old('maximum_limit')? old('maximum_limit') : ((\App\WithdrawalDetails::where('type','Doctor')->firstOrFail()->maximum_limit)? \App\WithdrawalDetails::where('type','Doctor')->firstOrFail()->maximum_limit : '0')  }}" class="form-control" placeholder="Withdrawal Maximum limit" />
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Doctors Wallet Withdrawals Details</h3>
                                <div class="card-tools">
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    @if(\App\Agent::whereNotNull('is_doctor')->get()->count()>0)
                                        @foreach(\App\Agent::whereNotNull('is_doctor')->orderby('created_at','DESC')->get() as $row)
                                            <tr>
                                                <td>{{ $loop->index+1 }}</td>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('withdrawal-wallet.show-details', ['Doctors',$row->user->id])}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
