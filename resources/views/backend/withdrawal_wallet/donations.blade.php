...
@section('page_title','Donations Withdrawal Points Details')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Donations Wallet Withdrawals</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Donations Wallet Withdrawals</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title text-uppercase">Donation Withdrawal Fee Details</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                            <i class="fas fa-minus"></i>
                        </button>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <form action="{{ route('withdrawal-details.update',(\App\WithdrawalDetails::where('type','Donations')->firstOrFail()->id)) }}" method="POST">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label>Wallet Type</label>
                                        <input type="text" name="type" readonly value="{{ old('type')? old('type') : 'Donations'  }}" class="form-control" placeholder="Wallet type" />
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <input type="text" id="withdrawal_fee" name="fee_amount" value="{{ old('fee_amount')? old('fee_amount') : ((\App\WithdrawalDetails::where('type','Donations')->firstOrFail()->fee_amount)? \App\WithdrawalDetails::where('type','Donations')->firstOrFail()->fee_amount : null)  }}" class="form-control" placeholder="Withdrawal Fee Amount" />
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" id="minimum_limit" name="minimum_limit" value="{{ old('minimum_limit')? old('minimum_limit') : ((\App\WithdrawalDetails::where('type','Donations')->firstOrFail()->minimum_limit)? \App\WithdrawalDetails::where('type','Donations')->firstOrFail()->minimum_limit : '0')  }}" class="form-control" placeholder="Withdrawal Minimum limit" />
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" id="maximum_limit" name="maximum_limit" value="{{ old('maximum_limit')? old('maximum_limit') : ((\App\WithdrawalDetails::where('type','Donations')->firstOrFail()->maximum_limit)? \App\WithdrawalDetails::where('type','Donations')->firstOrFail()->maximum_limit : '0')  }}" class="form-control" placeholder="Withdrawal Maximum limit" />
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title text-uppercase">Automatic Points Transfer Time Period</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                            <i class="fas fa-minus"></i>
                        </button>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <p><i class="fa fa-info-circle"></i> Automatic Total Wallet Point Transfer to Donation Wallet It happen if a user is inactive for more than
                                {{ \App\Details::where('key','auto_withdrawal_time')->firstOrFail()->value }} months.</p>
                            <form action="{{ route('withdrawal-details.update.w-time') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="form-group col-3">
                                        <label>Time period <span class="required">*</span></label>
                                        <input type="number" min="1" max="12" oninput="validity.valid||(value='');" required name="time" value="{{ old('time')? old('time') : ((\App\Details::where('key','auto_withdrawal_time')->firstOrFail()->value)? \App\Details::where('key','auto_withdrawal_time')->firstOrFail()->value : null)  }}" class="form-control" placeholder="Time period" />
                                        @error('fee_amount') <div class="form-control-feedback text-danger text-sm">{{$message}}</div>@enderror
                                    </div>
                                    @permission('update-Withdrawal-Details')
                                    <div class="col-md-12">
