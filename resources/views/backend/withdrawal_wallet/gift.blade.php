...
@section('page_title','Bonus/Gift Withdrawal Points Details')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Bonus/Gift Wallet Withdrawals</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.home') }}">Dashboard</a></li>
                            <li class="breadcrumb-item active">Bonus/Gift Wallet Withdrawals</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
        ...
        <section class="content">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title text-uppercase">Bonus/Gift Withdrawal Fee Details</h3>
                    <div class="card-tools">
                        <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
                            <i class="fas fa-minus"></i>
                        </button>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12 col-sm-12">
                            <form action="{{ route('withdrawal-details.update',(\App\WithdrawalDetails::where('type','Bonus')->firstOrFail()->id)) }}" method="POST">
                                @csrf
                                @method('put')
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label>Wallet Type</label>
                                        <input type="text" name="type" readonly value="{{ old('type')? old('type') : 'Bonus'  }}" class="form-control" placeholder="Wallet type" />
                                    ...
                                    <div class="form-group col-3">
                                        ...
                                        <input type="text" id="withdrawal_fee" name="fee_amount" value="{{ old('fee_amount')? old('fee_amount') : ((\App\WithdrawalDetails::where('type','Bonus')->firstOrFail()->fee_amount)? \App\WithdrawalDetails::where('type','Bonus')->firstOrFail()->fee_amount : null)  }}" class="form-control" placeholder="Withdrawal Fee Amount" />
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" id="minimum_limit" name="minimum_limit" value="{{ old('minimum_limit')? old('minimum_limit') : ((\App\WithdrawalDetails::where('type','Bonus')->firstOrFail()->minimum_limit)? \App\WithdrawalDetails::where('type','Bonus')->firstOrFail()->minimum_limit : '0')  }}" class="form-control" placeholder="Withdrawal Minimum limit" />
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input type="text" id="maximum_limit" name="maximum_limit" value="{{ old('maximum_limit')? old('maximum_limit') : ((\App\WithdrawalDetails::where('type','Bonus')->firstOrFail()->maximum_limit)? \App\WithdrawalDetails::where('type','Bonus')->firstOrFail()->maximum_limit : '0')  }}" class="form-control" placeholder="Withdrawal Maximum limit" />
