...
@section('page_title','Pending Reservations')
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="margin" style="margin-bottom: 10px;">
                            <div class="btn-group">
                                <a href="{{ route('reservations.pending') }}" class="btn btn-info btn-block"><i class="fa fa-refresh"></i> Reload</a>
                            </div>
                            {{--<div class="btn-group">--}}
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">All Pending Reservations</h3>
                            ...
                            <div class="card-body">
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    @if(\App\Service_booking::whereNull('is_deleted')->where('status','Pending')->get()->count()>0)
                                        @foreach(\App\Service_booking::whereNull('is_deleted')->where('status','Pending')->orderby('created_at','DESC')->get() as $row)
                                            ...
                                            @else
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="{{ route('reservations.pending.show', HashEncode($row->id))}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
