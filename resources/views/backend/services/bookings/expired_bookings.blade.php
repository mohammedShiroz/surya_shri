...
@section('page_title','Expired Reservations')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Postponed/Expired Reservations</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Postponed/Expired Reservations</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="margin" style="margin-bottom: 10px;">
                            <div class="btn-group">
                                <a href="{{ route('reservations.expired') }}" class="btn btn-info btn-block"><i class="fa fa-refresh"></i> Reload</a>
                            </div>
                            {{--<div class="btn-group">--}}
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">All Expired Reservations</h3>
                                        ...
                                        @foreach(\App\Service_booking::whereNull('is_deleted')->orderby('created_at','DESC')->get() as $row)
                                            @if(\Carbon\Carbon::now()->subDays(1)->between(new DateTime(), new DateTime($row->book_date)))
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            <a href="{{ route('reservations.expired.show', HashEncode($row->id))}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
