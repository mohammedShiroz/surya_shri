    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>Doctor Wallet Points Details</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">Doctor Wallet Points Details</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                                    ...
                                    <div class="tab-pane" id="points_commission">
                                        <div class="card-body" style="padding: 0 !important;">
                                            <table id="example1" class="table table-bordered table-striped w-100">
                                                ...
                                                <tbody>
                                                @if(\App\Seller_points::where('user_id',$data->id)->where('type','Service')->get()->count()>0)
                                                    @foreach(\App\Seller_points::where('user_id',$data->id)->where('type','Service')->orderby('created_at','DESC')->get() as $row)
                                                        <tr>
                                                            ...
                                                            <td><a href="{{ route('reservations.show', HashEncode($row->booking->id))}}">SSA/BK/{{ $row->booking->book_reference }}</a></td>
