...
@section('page_title','Users Points')
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active">Users Wallet</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">All User Wallet Points</h3>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    @if(\App\User::whereNull('is_deleted')->whereNull('agent_id')->get()->count()>0)
                                        @foreach(\App\User::whereNull('is_deleted')->whereNull('agent_id')->orderby('created_at','asc')->get() as $row)
                                            <tr>
                                                <td>
                                                    <a href="{{ route('users.show', $row->id)}}">({{ $row->id }}) {{ $row->name." ".$row->last_name }}</a>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="{{ route('user-points.show', $row->id)}}" class="btn btn-success"><i class="fa fa-eye"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforeach
