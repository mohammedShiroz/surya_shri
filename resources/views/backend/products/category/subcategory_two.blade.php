...
@section('page_title','Product Sub Category Detail')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h3>{{ $data->name }} - {{ $data->parent->name }}'s Sub-Category Detail</h3>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('product-category.index') }}">Product Categories</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('product-category.show',$data->parent->id) }}">{{ $data->parent->name }}</a></li>
                ...
                <div class="row">
                    <div class="col-3">
                        <div class="callout callout-info">
                            <h5><strong><i class="fa fa-tags pr-2"></i> Category Level</strong></h5>
                            Second Category
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="callout callout-info">
                            <h5><strong><i class="fa fa-question-circle-o pr-2"></i> Sub Category Name</strong></h5>
                            {{ $data->name }}
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="callout callout-info">
                            <h5><strong><i class="fa fa-eye pr-2"></i> Visibility</strong> </h5>
                    ...
                    <div class="col-3">
                        <div class="callout callout-info">
                            <h5><strong><i class="fa fa-list-alt pr-2"></i> Sequence</strong></h5>
                    ...
                    <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h4>
                                        <i class="fas {{ isset($edit_enabled)? 'fa-edit' : 'fa-plus-circle' }} "></i> {{ isset($edit_enabled)? 'Edit '.$data->name.'\'s '.$data_two->name : 'Add a'.$data->name.'\'s' }} Level 2 Sub-category
                                    </h4>
                                </div>
                                <!-- /.col -->
                            </div>
                            ...
                            <div class="card-body">
                                @if(!isset($edit_enabled))
                                    <form action="{{ route('product-category.sub-category.store') }}" method="post" class="form-horizontal" role="form">
                                        ...
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-2 col-form-label">L2 Sub-category Name</label>
                                            <div class="col-sm-10">
                                ...
                                @else
                                    <form action="{{ route('product-category.sub-category.update',$data_two->id) }}" method="POST" class="form-horizontal" role="form">
                                        @csrf
                                        @method('PUT')
                                        <input type="hidden" name="is_category_three" value="true" />
                                        <div class="form-group row">
                                            <div class="col-sm-10 mb-3">
                                                <div class="icheck-primary d-inline">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                ...
                                                <input type="hidden" name="parent_id" value="{{ $data->id }}" />
                                                <input type="hidden" name="main_category_id" value="{{ $data->id }}" />
                                                @error('name')
                                                <div class="form-control-feedback text-danger text-sm">{{$message}}</div>
                                                @enderror
                                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h4>
                                        <i class="fas fa-tags"></i> All {{ $data->name }} L2 Sub-categories
                                    </h4>
                                </div>
                                <!-- /.col -->
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="btn-group">
                                                            ...
                                                            <a href="{{ route('product-category.sub_third_edit', [$data->parent->id,$data->id,$row->id,])}}" class="btn btn-info"><i class="fa fa-edit"></i></a>
                                                            @endpermission
