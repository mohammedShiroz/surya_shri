...
@section('page_title',$type.' Notifications')
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ $type }} Notifications</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
                            <li class="breadcrumb-item active">{{ $type }} Notifications</li>
                        </ol>
                    </div>
                </div>
            </div><!-- /.container-fluid -->
                            ...
                            @else
                                <div class="col-md-12 col-sm-12">
                                    ...
                                    <div class="card card-widget">
                                        ...
                                        <div class="card-body">
                                            <!-- post text -->
                                            <p class="text-capitalize pt-3"><i class="fa fa-info-circle"></i> No Notification</p>
                                            <!-- Social sharing buttons -->
                                        </div>
                                        <!-- /.card-body -->
                                    </div>
...
@push('script')
    <script type="text/javascript">
        $(window).on('load', function() {
            $.ajax({
                url: "{{ route('notifications.update-notifications',$type) }}",
                type: "POST",
                headers: {'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')},
                data: { },
                cache: false,
                success: function (result) {
                    $('#fetch_notifications').empty().html(result.data);
                }
            });
