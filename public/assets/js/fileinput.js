 ...
 */
(function ($) {
    var STYLE_SETTING = 'style="width:{width};height:{height}; border: 3px solid #c9c9c9;"';
    ...
    var defaultLayoutTemplates = {
        ...
        '   <div class="close fileinput-remove text-right" style="margin-top: 10px; margin-right: 5px;">&times;</div>\n' +
        ...
        '        <button type="button" class="close" id="close_" data-dismiss="modal" aria-hidden="true">&times;</button>\n' +
    ...
    FileInput.prototype = {
        ...
        readFiles: function (files) {
            ...
            function readFile(i) {
                if (i >= numFiles) {
                    $container.removeClass('loadingg');
                    $status.html('');
                    return;
                }
        ...
        updateFileDetails: function (numFiles) {
            ...
            if (self.isError) {
                self.$previewContainer.removeClass('loadingg');
        ...
        renderBrowse: function () {
            var self = this, css = self.browseClass + ' btn-file btn btn-info no ', status = '';
            if (self.isDisabled) {
                status = ' disabled ';
            }
            return '<div class="' + css + '"' + status + ' style="border-radius: 0 !important;"> ' + self.browseIcon + self.browseLabel + ' </div>';
        },
