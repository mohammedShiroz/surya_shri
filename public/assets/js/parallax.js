...
!function (a) {
    ...
    !function () {
        ...
        window.requestAnimationFrame || (window.requestAnimationFrame = function (e) {
            var t = (new Date).getTime(), i = Math.max(0, 16 - (t - a)), r = window.setTimeout(function () {
                e(t + i)
            }, i);
            return a = t + i, r
        ...
        var e = a(window), t = {top: e.scrollTop(), left: e.scrollLeft()};
        ...
        return this.each(function () {
            ...
            var l, p, c, s, d, m, g, x, u, h, w, f, b, k, v, D, z, y, F = a(this), A = a(window), S = 0, q = 0, B = 0,
                T = 0, j = 1, I = {
                    parallaxBgImage: "",
